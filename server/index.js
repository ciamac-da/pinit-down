...
 
// Resend HTTP API sender (works on Render free tier - no SMTP needed)
...
  try {
    // Resend (HTTP-based, works on all hosts including Render free tier)
...
 
// Unified email sender - uses Resend API or nodemailer transporter
